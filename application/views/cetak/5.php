...
$pdf->Cell(6,0.5,': Permohonan Bantuan Bahan dalam Rangka Penelitian Tugas Akhir',0,1, 'L');
$pdf->Ln(0.5);
...
$pdf->Ln(0.25);
$pdf->SetFont('Times','',12);
$pdf->MultiCell(16,0.5,'Dengan ini, Kami Pimpinan Fakultas Matematika dan Ilmu Pengetahuan Alam (MIPA) Universitas Islam Indonesia Yogyakarta bermaksud menyampaikan permohonan Bantuan bahan penelitian bagi mahasiswa Kami di bawah ini :','J');
$pdf->Cell(4,0.5,'Nama',0,0,'L');
$pdf->Cell(0.25,0.5,': ',0,0,'L');
$pdf->Cell(11.75,0.5,$namaUC,0,1, 'L');
...
$pdf->SetFont('Times','',12);
$pdf->Ln(0.25);
$pdf->Cell(11,0.5,'Mengetahui',0,0,'L');
...
$pdf->MultiCell(8,0.5,''.$pembimbing1,'J');
$pdf->Ln(0.15);
$pdf->Cell(8,0.5,'NIP:'.$nip1,0,0,'L');
$pdf->Cell(8,0.5,'NIP:'.$nip2,0,0,'L');
