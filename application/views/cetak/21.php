...
$pdf->Cell(6,0.5,': Permohonan Izin Determinasi',0,1, 'L');
$pdf->Ln(0.5);
...
$pdf->Ln(0.25);
$pdf->SetFont('Times','',12);
$pdf->MultiCell(16,0.5,'Bersama ini Kami Pimpinan Fakultas Matematika dan Ilmu Pengetahuan Alam Universitas Islam Indonesia Yogyakarta menerangkan bahwa yang disebutkan di bawah ini :','J');
$pdf->Ln(0.5);
$pdf->Cell(4,0.5,'Nama',0,0,'L');
$pdf->Cell(8,0.5,': '.$namaUC,0,1, 'L');
$pdf->Cell(4,0.5,'NIM',0,0,'L');
$pdf->Cell(8,0.5,': '.$nim,0,1, 'L');
$pdf->Cell(4,0.5,'Judul',0,0,'L');
$pdf->Cell(0.25,0.5,': ',0,0,'L');
$pdf->MultiCell(11.75,0.5,$judul,'J');
$pdf->Ln(0.75);
$pdf->Cell(4,0.5,'Pembimbing Skripsi I',0,0,'L');
$pdf->Cell(8,0.5,': '.$pembimbing1,0,1, 'L');
if($pembimbing2!='')
{
$pdf->Cell(4,0.5,'Pembimbing Skripsi II',0,0,'L');
$pdf->Cell(8,0.5,': '.$pembimbing2,0,1, 'L');
}
$pdf->Ln(0.25);
$pdf->MultiCell(16,0.5,'Adalah benar-benar mahasiswa Fakultas MIPA Universitas Islam Indonesia Yogyakarta. Selanjutnya Kami mohon dengan hormat kepada Bapak/Ibu agar mahasiswa tersebut diijinkan melakukan Determinasi di Instansi yang Bapak/Ibu pimpin dalam rangka penyelesaian Tugas Akhir/Skripsi Program S-1.','J');
$pdf->Ln(0.25);
$pdf->MultiCell(16,0.5,'Demikian permohonan Kami, atas bantuan dan kerjasamanya Kami ucapkan terima kasih.','J');
$pdf->Ln(0.25);
$pdf->SetFont('Times','I',12);
$pdf->MultiCell(16,0.5,'Wassalamualaikum Wr.Wb.','J');
$pdf->SetFont('Times','',12);
$pdf->Ln(0.25);
$pdf->Cell(8,0.5,'Mengetahui',0,0,'L');
$pdf->MultiCell(8,0.5,' ','J');
$pdf->Cell(8,0.5,$ttd.',',0,0,'L');
$pdf->MultiCell(8,0.5,'Dosen Pembimbing,','J');
$pdf->Ln(1.75);
$pdf->SetFont('Times','B',12);
$pdf->Cell(8,0.5,''.$nama_ttd,0,0,'L');
$pdf->Cell(8,0.5,''.$pembimbing1,0,0,'L');
$pdf->Ln(0.5);
$pdf->Cell(8,0.5,'NIP:'.$nip,0,0,'L');
$pdf->Cell(8,0.5,'NIP:'.$nip1,0,0,'L');
