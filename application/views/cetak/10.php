...
$pdf->Cell(6,0.5,': Pengantar Tugas Akhir',0,1, 'L');
$pdf->Ln(0.5);
...
$pdf->Ln(0.25);
$pdf->SetFont('Times','',12);
$pdf->MultiCell(16,0.5,'Bersama ini, Kami Pimpinan Fakultas Matematika dan Ilmu Pengetahuan Alam (MIPA) Universitas Islam Indonesia Yogyakarta bermaksud menyampaikan Surat Pengantar dalam rangka Tugas Akhir bagi mahasiswa Kami di bawah ini :','J');
$pdf->Ln(0.5);
