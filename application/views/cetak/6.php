...
$pdf->Cell(6,0.5,': Ijin Observasi',0,1, 'L');
$pdf->Ln(0.5);
...
$pdf->Cell(0.25,0.5,': ',0,0,'L');
$pdf->MultiCell(11.75,0.5,$tempat,'J');
$pdf->Cell(4,0.5,'Judul Penelitian',0,0,'L');
$pdf->Cell(0.25,0.5,': ',0,0,'L');
$pdf->MultiCell(12,0.5,$judul,'J');
$pdf->Ln(0.25);
...
$pdf->Ln(0.15);
$pdf->Cell(8,0.5,'NIP:'.$nik,0,0,'L');
$pdf->Cell(8,0.5,'NIP:'.$nik1,0,0,'L');
