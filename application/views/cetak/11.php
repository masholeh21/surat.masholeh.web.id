...
$pdf->Cell(6,0.5,': Surat Ijin Peminjaman Laboratorium',0,1, 'L');
$pdf->Ln(0.5);
...
$pdf->Ln(0.25);
$pdf->SetFont('Times','',12);
$pdf->MultiCell(16,0.5,'Bersama ini, Kami Pimpinan Fakultas Matematika dan Ilmu Pengetahuan Alam (MIPA) Universitas Islam Indonesia Yogyakarta bermaksud menyampaikan permohonan ijin menggunakan laboratorium bagi mahasiswa Kami sebagai berikut :','J');
$pdf->Ln(0.5);
