...
$penutup="Selanjutnya kami mohon kesediaannya untuk memberikan pembimbing dan bimbingan selama PKL dan penilaian terhadap mahasiswa tersebut. Adapun beberapa topik tugas akhir mahasiswa kami antara lain Validasi/Verifikasi Metode, Uji Perbandingan Metode, Pengembangan Metode, Pengendalian dan Jaminan Mutu serta topik-topik lain yang berhubungan dengan pengujian di laboratorium kimia.";
...
$isi="Memperhatikan surat Pimpinan dengan nomor $nomersurat tertanggal $hariini, bersama surat ini kami mengucapkan terima kasih atas pemberian izin Praktik Kerja Lapangan mahasiswa kami : ";
// menuliskan datanya
// $pdf->Ln(2);
$pdf->SetFont('Times','',12);
...
$pdf->Cell(6.5,0.5,': Sertifikat Penilaian PKL',0,0,'L');
$pdf->Ln(0.5);
$pdf->SetFont('Times','',12);
$pdf->Cell(1.5,0.5,'Hal',0,0,'L');
$pdf->Cell(6.5,0.5,': Pengantar PKL',0,0,'L');
$pdf->Ln(1);
...
$pdf->Cell(1.5,0.5,'',0,0,'L');
$pdf->SetFont('Times','',12);
$pdf->Cell(6,0.5,$namaUC,1,0, 'C');
$pdf->Cell(3.5,0.5,$nim,1,0, 'C');
$pdf->Cell(5,0.5,$jurusan,1,0, 'C');
$pdf->Ln(0.5);
if($itmk['mhs1']!='')
{
  $pdf->Cell(1.5,0.5,'',0,0,'L');
  $pdf->Cell(6,0.5,$mhs1,1,0, 'C');
  $pdf->Cell(3.5,0.5,$nim1,1,0, 'C');
  $pdf->Cell(5,0.5,$jurusan,1,0, 'C');
}
if($itmk['mhs2']!='')
{
