...
$pembimbing1=$surat5['pembimbing1'];
$lokasi=$surat5['lokasi'];
$kota=$surat5['kota'];
$alasan=$surat5['maksud'];
...
$penutup="bermaksud mengundurkan diri dari Praktek Kerja Lapangan di Instansi yang bapak/ibu Pimpin. Hal tersebut dikarenakan $alasan dan Praktek Kerja Lapangan membutuhkan data dan pengamatan yang dilaksanakan selama waktu yang telah ditetapkan dengan Laporan Tugas Akhir sebagai output-nya. Kami berharap agar mahasiswa kami yang lain tetap diberikan kesempatan melaksanakan Praktek Kerja Lapangan di instansi yang Bapak/Ibu Pimpin.";
...
$isi="Bersama ini kami dari Program Studi DIII Analisis Kimia Fakultas Matematika dan Ilmu Pengetahuan Alam Universitas Islam Indonesia Yogyakarta menyampaikan permohonan maaf kepada Bapak/Ibu Pimpinan $lokasi dikarenakan mahasiswa kami:";
// menuliskan datanya
// $pdf->Ln(2);
$pdf->SetFont('Times','',12);
...
$pdf->Cell(6.5,0.5,': Surat Tanda Diterima',0,0,'L');
$pdf->Ln(0.5);
$pdf->SetFont('Times','B',12);
$pdf->Cell(1.5,0.5,'Hal',0,0,'L');
$pdf->Cell(6.5,0.5,': Pengunduran Diri PKL',0,0,'L');
$pdf->Ln(1);
...
$pdf->Cell(3.5,0.5,'NIM',1,0, 'C');
$pdf->Cell(5,0.5,'Program Studi',1,0, 'C');
$pdf->Ln(0.5);
$pdf->Cell(1.5,0.5,'',0,0,'L');
$pdf->SetFont('Times','',12);
$pdf->Cell(6,0.5,$namaUC,1,0, 'L');
$pdf->Cell(3.5,0.5,$nim,1,0, 'L');
$pdf->Cell(5,0.5,$jurusan,1,0, 'L');
$pdf->Ln(0.5);
if($itmk['mhs1']!='')
{
  $pdf->Cell(1.5,0.5,'',0,0,'L');
  $pdf->Cell(6,0.5,$mhs1,1,0, 'L');
  $pdf->Cell(3.5,0.5,$nim1,1,0, 'L');
  $pdf->Cell(5,0.5,$jurusan,1,0, 'L');
}
if($itmk['mhs2']!='')
{
...
$pdf->Ln(0.5);
$pdf->Cell(1.5,0.5,'',0,0,'L');
$pdf->multiCell(14.5,0.5,'Demikian surat pengantar ini kami sampaikan, atas perhatiannya diucapkan banyak terima kasih.','J');
$pdf->SetFont('Times','I',12);
$pdf->Ln(0.25);
$pdf->Cell(1.5,0.5,'',0,0,'L');
